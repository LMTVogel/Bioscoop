...
{
    [Fact]
    public void CalculatePrice_Should_Return_13_For_1_Premium_And_1_Normal_Ticket_On_Weekday()
    {
        // Arrange
        ...
        // Assert
        Assert.Equal(13M, price);
    }

    [Fact]
    public void CalculatePrice_Should_Return_54_For_6_Normal_Tickets_On_Weekend()
    {
        // Arrange
        var movie = new Movie("Test Movie");
        var order = new Order(2, false);
        var movieScreening = new MovieScreening(movie, new DateTime(2024, 2, 4), 10);
        for (int i = 0; i < 6; i++)
        {
    ...
    [Fact]
    public void CalculatePrice_Should_Return_23_For_1_Premium_And_3_Normal_Tickets_On_Weekday()
    {
        // Arrange
        var movie = new Movie("Test Movie");
        var order = new Order(3, false);
        var movieScreening = new MovieScreening(movie, new DateTime(2024, 2, 1), 10);
        order.AddSeatReservation(new MovieTicket(movieScreening, 1, 1, true)); // Premium ticket
        for (int i = 0; i < 3; i++)
        {
    ...
    [Fact]
    public void CalculatePrice_Should_Return_34_For_3_Premium_And_3_Normal_Tickets_On_Weekday()
    {
        // Arrange
        var movie = new Movie("Test Movie");
        var order = new Order(4, true);
